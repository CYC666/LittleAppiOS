...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        self.textBottomHeight   =   kScreenHeight * 0.4;
        self.fadeTime           =   2.0;
...
+ (void)fadeShowWith:(NSString *)string
{
    FadeAlertView *view = [[FadeAlertView alloc]init];
    [view showAlertWith:string];
}

+ (void)fadeShowWithNoNet
{
    FadeAlertView *view = [[FadeAlertView alloc]init];
    [view showAlertWith:@"网络连接失败，请稍后重试"];
}

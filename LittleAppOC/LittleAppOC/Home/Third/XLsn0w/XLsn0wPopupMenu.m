...
+ (UIColor *)bottomLineColorForStyle:(XLsn0wPopupMenuStyle)style {
    return style == XLsn0wPopupMenuStyleDefault ? [UIColor colorWithRed:0.75 green:0.75 blue:0.75 alpha:1.00] : [UIColor whiteColor];//colorWithRed:0.4 green:0.4 blue:0.4 alpha:1.00
}
